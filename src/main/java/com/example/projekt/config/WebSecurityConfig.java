...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(
        AuthenticationManagerBuilder auth)
            throws Exception {
        // Konfiguracja menadżera AuthenticationManager, aby wiedział skąd pobrać dane użytkownika do sprawdzenia
    ...
    protected void configure(
        ...
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests()
                .antMatchers(
                        "/registrationPage", "/register", "/", "/loginPage", "/authenticate", "/tasksPage"
                )
                .permitAll()
